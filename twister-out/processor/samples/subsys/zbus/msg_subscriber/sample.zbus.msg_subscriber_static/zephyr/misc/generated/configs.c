...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_MSG_SUBSCRIBER_SAMPLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_HEAP_LISTENER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_LISTENER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_MSG_SUBSCRIBER_NET_BUF_STATIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_MSG_SUBSCRIBER_NET_BUF_POOL_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_MSG_SUBSCRIBER_NET_BUF_STATIC_DATA_SIZE, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_LOG_LEVEL, 4);
